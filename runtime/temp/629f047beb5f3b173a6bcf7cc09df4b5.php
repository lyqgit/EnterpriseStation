<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"F:\wamp\www\wlcg/application/admin\view\index\admin_add.html";i:1499689330;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-add" method="post" action="<?php echo url('admin/admin/add'); ?>">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>管理员名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="adminName" name="admin">
			</div>
		</div>
		<div class="row cl">
