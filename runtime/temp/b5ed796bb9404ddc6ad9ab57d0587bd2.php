<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:56:"F:\wamp\www\wlcg/application/admin\view\index\index.html";i:1499871124;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="<?php echo url('admin/index/index'); ?>">H-ui.admin</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a>
		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				<li><?php echo $user['group']; ?></li>
				<li class="dropDown dropDown_hover">
					<a href="#" class="dropDown_A"><?php echo $user['name']; ?> <i class="Hui-iconfont">&#xe6d5;</i></a>
					<ul class="dropDown-menu menu radius box-shadow">
						<!--<li><a href="javascript:;" onClick="myselfinfo()">个人信息</a></li>
						<li><a href="#">切换账户</a></li>-->
						<li><a href="<?php echo url('admin/login/login_out'); ?>">退出</a></li>
				</ul>
			</li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<?php if($user['group'] == '超级管理员'): ?>
			<dl id="menu-article">
				<dt><i class="Hui-iconfont">&#xe616;</i> 新闻中心<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
				<dd>
					<ul>
						<li><a data-href="article_list.html" data-title="新闻管理" href="javascript:void(0)">新闻管理</a></li>
						<li><a data-href="article_class.html" data-title="新闻分类管理" href="javascript:void(0)">新闻分类管理</a></li>
					</ul>
				</dd>
			</dl>
			<dl id="menu-product">
				...
				<dd>
					<ul>
						<li><a data-href="product_list.html" data-title="产品管理" href="javascript:void(0)">产品管理</a></li>
						<li><a data-href="product_class.html" data-title="产品分类管理" href="javascript:void(0)">产品分类管理</a></li>
					</ul>
				</dd>
			</dl>
			<dl id="menu-comments">
				...
				<dd>
					<ul>
						<li><a data-href="feedback_list.html" data-title="留言列表" href="javascript:;">留言列表</a></li>
					</ul>
				</dd>
			</dl>
			<dl id="menu-admin">
				...
				<dd>
					<ul>
						<li><a data-href="admin_power.html" data-title="权限管理" href="javascript:void(0)">权限管理</a></li>
						<li><a data-href="admin_list.html" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
					</ul>
				</dd>
			</dl>
		<?php else: if($user['power']['新闻中心'] == '1'): ?>
			<dl id="menu-article">
				<dt><i class="Hui-iconfont">&#xe616;</i> 新闻中心<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
				<dd>
					<ul>
			...
			<?php endif; if($user['power']['产品中心'] == '1'): ?>
			<dl id="menu-product">
				<dt><i class="Hui-iconfont">&#xe620;</i> 产品中心<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
				<dd>
					<ul>
			...
			<?php endif; if($user['power']['评论管理'] == '1'): ?>
			<dl id="menu-comments">
				<dt><i class="Hui-iconfont">&#xe622;</i> 评论管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
				<dd>
					<ul>
			...
			<?php endif; if($user['power']['管理员管理'] == '1'): ?>
			<dl id="menu-admin">
				<dt><i class="Hui-iconfont">&#xe62d;</i> 管理员管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
				<dd>
					<ul>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="__HUI__/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
