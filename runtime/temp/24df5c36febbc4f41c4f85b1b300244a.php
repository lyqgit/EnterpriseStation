<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"F:\wamp\www\wlcg/application/admin\view\index\article_class.html";i:1499685129;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20 text-c">
  <form class="form form-horizontal" action="<?php echo url('admin/article/category_add'); ?>" method="post">
    <div class="row cl">
...
function article_class_del(obj,id){
  layer.confirm('确认要删除吗？',function(index){
    $.ajax({
      type: 'POST',
      url: '<?php echo url("admin/article/category_del"); ?>',
      data: {'category_id':id},
      dataType: 'json',
