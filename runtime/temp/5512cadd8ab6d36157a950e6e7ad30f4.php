<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:56:"F:\wamp\www\wlcg/application/admin\view\login\login.html";i:1499581435;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="<?php echo url('admin/login/verify'); ?>" method="post">
      <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <input name="yzm" class="input-text size-L" type="text" placeholder="验证码" onblur="if(this.value==''){this.value='验证码:'}" onclick="if(this.value=='验证码:'){this.value='';}" value="验证码:" style="width:150px;">
          <img src="<?php echo captcha_src(); ?>" onclick="this.src='<?php echo captcha_src(); ?>?id='+Math.random()" title="看不清楚，点击刷新"></div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
