<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"F:\wamp\www\wlcg/application/admin\view\admin\power_edit.html";i:1499757381;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<form action="" method="post" class="form form-horizontal" id="form-admin-role-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $edit['group_name']; ?>" id="roleName" name="role">
				<input type="hidden" name="authority_id" value="<?php echo $edit['authority_id']; ?>">
				<input type="hidden" name="group_id" value="<?php echo $edit['group_id']; ?>">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<dl class="permission-list">
					...
					<dd>
						<?php if(is_array($edit['authority_power']) || $edit['authority_power'] instanceof \think\Collection || $edit['authority_power'] instanceof \think\Paginator): if( count($edit['authority_power'])==0 ) : echo "" ;else: foreach($edit['authority_power'] as $k=>$vo): ?>
						<dl class="cl permission-list2">
							...
							<dd>
								<label class="">
									<input type="radio" <?php if($vo == '1'): ?>checked<?php endif; ?> value="1" name="<?php echo $k; ?>">
									显示
								</label>
								<label class="">
									<input type="radio" <?php if($vo == '0'): ?>checked<?php endif; ?> value="0" name="<?php echo $k; ?>">
									不显示
								</label>
							</dd>
						</dl>
...
$(function(){
	$("#form-admin-role-add").validate({
		...
		submitHandler:function(form){
			$(form).ajaxSubmit({
				type: 'post',
				url: "<?php echo url('admin/admin/power_edit'); ?>" ,
