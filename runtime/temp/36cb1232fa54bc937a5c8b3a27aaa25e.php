<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"F:\wamp\www\wlcg/application/admin\view\admin\admin_edit.html";i:1499684530;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-add" method="post" action="<?php echo url('admin/admin/edit'); ?>">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>管理员名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $edit['user_name']; ?>" id="adminName" name="admin">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="password" class="input-text" autocomplete="off" placeholder="请输入新密码，如果为空，则密码不修改" id="password" name="password">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
				<select class="select" name="role" size="1">
					<?php if(is_array($group) || $group instanceof \think\Collection || $group instanceof \think\Paginator): $i = 0; $__LIST__ = $group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<option <?php if($edit['user_group'] == $vo['group_id']): ?> selected <?php endif; ?> value="<?php echo $vo['group_id']; ?>"><?php echo $vo['group_name']; ?></option>
