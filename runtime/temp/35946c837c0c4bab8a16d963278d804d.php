<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"F:\wamp\www\wlcg/application/admin\view\index\article_add.html";i:1499499059;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
	<form class="form form-horizontal" action="<?php echo url('admin/article/add'); ?>" enctype="multipart/form-data" method="post">
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">文章创建时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
