<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"F:\wamp\www\wlcg/application/admin\view\product\product_edit.html";i:1499871375;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
	<form class="form form-horizontal" action="<?php echo url('admin/product/edit'); ?>" enctype="multipart/form-data" method="post">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>文章标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $article['product_name']; ?>" placeholder="" id="articletitle" name="title">
				<input type="hidden" name="id" value="<?php echo $article['product_id']; ?>">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="type" class="select">
					<?php if(is_array($category) || $category instanceof \think\Collection || $category instanceof \think\Paginator): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
						<option <?php if($article['product_type'] == $v['category_id']): ?>selected<?php endif; ?> value="<?php echo $v['category_id']; ?>"><?php echo $v['category_name']; ?></option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="abstract" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！"><?php echo $article['product_description']; ?></textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<img src="<?php echo $article['product_image']; ?>">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">文章内容：</label>
			<div class="formControls col-xs-8 col-sm-9"> 
				<script id="editor" type="text/plain" style="width:100%;height:400px;"><?php echo $article['product_content']; ?></script>
			</div>
		</div>
		<div class="row cl">
