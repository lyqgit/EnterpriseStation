<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"F:\wamp\www\wlcg/application/admin\view\product\product_class_edit.html";i:1499871532;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<body>
<div class="pd-20">
  <form class="Huiform" action="<?php echo url('admin/product/category_edit'); ?>" method="post">
    上级栏目：
